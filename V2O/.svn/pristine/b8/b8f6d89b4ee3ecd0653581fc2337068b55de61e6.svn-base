...
#include "tx_io_params_menu_gen.h"



int get_tx_serial_config(HAL *hp, struct serial_config *serial_cfg) {

    struct tx_io_parm_params params;
    memset(&params, 0x00, sizeof(params));
    params.userptr = hp;
    retrieveTxIOParametersValues(&params);

    serial_cfg->serial_enable = params.serial_enable_value;

    switch (params.serial_baudrate_value) {
    case TX_IO_PARM_SERIAL_BAUDRATE_300:
        serial_cfg->baudrate = 300;
        break;
    case TX_IO_PARM_SERIAL_BAUDRATE_600:
        serial_cfg->baudrate = 600;
        break;
    case TX_IO_PARM_SERIAL_BAUDRATE_1200:
        serial_cfg->baudrate = 1200;
        break;
    case TX_IO_PARM_SERIAL_BAUDRATE_2400:
        serial_cfg->baudrate = 2400;
        break;
    case TX_IO_PARM_SERIAL_BAUDRATE_4800:
        serial_cfg->baudrate = 4800;
        break;
    case TX_IO_PARM_SERIAL_BAUDRATE_9600:
        serial_cfg->baudrate = 9600;
        break;
    case TX_IO_PARM_SERIAL_BAUDRATE_19200:
        serial_cfg->baudrate = 19200;
        break;
    case TX_IO_PARM_SERIAL_BAUDRATE_38400:
        serial_cfg->baudrate = 38400;
        break;
    case TX_IO_PARM_SERIAL_BAUDRATE_57600:
        serial_cfg->baudrate = 57600;
        break;
    case TX_IO_PARM_SERIAL_BAUDRATE_115200:
    ...
    case TX_IO_PARM_SERIAL_PARITY_EVEN:
        serial_cfg->parity = 'e';
        break;
    case TX_IO_PARM_SERIAL_PARITY_ODD:
        serial_cfg->parity = 'o';
        break;
    case TX_IO_PARM_SERIAL_PARITY_NONE:
        serial_cfg->parity = 'n';
        break;
    }

    switch (params.serial_flowcontrol_value) {
    case TX_IO_PARM_SERIAL_FLOWCONTROL_HW:
        serial_cfg->flowcontrol = 'h';
        break;
    case TX_IO_PARM_SERIAL_FLOWCONTROL_SW:
        serial_cfg->flowcontrol = 's';
        break;
    case TX_IO_PARM_SERIAL_FLOWCONTROL_NONE:
...
int applyTxIOParameters(struct tx_io_parm_params *params,
                                  struct tx_io_parm_params
                                  *orig_params)
{
