...
//#BEGIN_HEADER
//Date = Sunday, March 03, 2013 12:48 PM
//File version = 3
...
//Output Clock 0
// Output Frequency (MHz) = 165.000000000
// Mux Selection = IDn
// MultiSynth = 15  5/33  (15.1515)
// R = 1
//Output Clock 1
...
// R = 1
//Output Clock 2
// Output Frequency (MHz) = 33.333300000
// Mux Selection = IDn
// MultiSynth = 75  25/333333  (75.0001)
// R = 1
//Output Clock 3
// Output Frequency (MHz) = 154.000000000
// Mux Selection = IDn
// MultiSynth = 16  18/77  (16.2338)
// R = 1
//Driver 0
// Enabled
// Powered on
// Output voltage = 2.50
// Output type = 2.5V CML
...
// Powered on
// Output voltage = 1.50
// Output type = 1.5V HSTL on A and B
// Output state when disabled = Tristate
...
//Clock 3 frequency increment and decrement is enabled 
//Clock 3 frequency inc/dec step size (Hz) = 1000.000
...
const Reg_Data netvizxpi_si5338[NUM_REGS_MAX] = {
{  0,0x00,0x00},
{  1,0x00,0x00},
{  2,0x00,0x00},
{  3,0x00,0x00},
...
//End of file
//CHECKSUM = 19D129A0F6558F9E9EAA1FE7245459C6F229E92A
