...
#ifndef __LUT_TABLE_H__
#define __LUT_TABLE_H__

#define V2_CLOCK_FREQ    	38880000
#define V4_CLOCK_FREQ    	33330000
#define XPI_CLOCK_FREQ	    62500000

/* Mask and shift for how coarse and fine noise values 
   are packed into the "a_noise" parameter of LUT */
...
#ifdef __KERNEL__
extern struct LUT_struct *find_lut_entry( struct v2d_board *board,
                                         unsigned short hsyncc, 
                                         unsigned short amvreg, 
                                         unsigned short amhreg, 
                                         unsigned short amtreg,
                                         int is_duallink,
                                         int is_hardware_interrupt);
extern int lut_table_init(struct v2d_board *board);
extern int lut_table_ioctl(struct v2d_board *board, unsigned int cmd, unsigned long data);
#endif

#endif /* __LUT_TABLE_H__ */
