...
#include "hal.h"
#include "read_video_statistics_status_menu_gen.h"

int getReadVideoStatisticsStatus(
        struct read_video_statistics_status_params *params)
{
    ...
    params->queue_limit_value = statio.video_stats.queue_limit;
