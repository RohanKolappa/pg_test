...
barco_dms_setup_wizard_en = {
  invalidMinChar1: 'Must contain at least ',
  invalidMinChar2: ' character',
  invalidMaxChar1: 'Must contain at most ',
  invalidMaxChar2: ' character',
  
  invalidDevLowercase: ' with lowercase alphanumerics.',
  invalidDevInitialLowercase: 'Going forward, devicenames must be all lowercase (to conform with XMPP standards)',
  ...
  invalidPwEmpty: 'Password should not be empty',
  ...
  errorLost: 'The connection to the SC device was lost. ' + 
...
function barco_dms_setup_wizard_en_plural(num) {
  return num===1 ? '' : 's';
}

function barco_dms_setup_wizard_en_plural_is(num) {
