...
console.log("barco_processCmdGood  response "+ response + "   Status:  " + status );
...
console.log("barco_processCmdBad  request "+ request + "   Status:  " + status + "   error:  " + error);
...
console.log("barco_processCmdData  id "+ id + "   Self:  " + self);
...
console.log("barco_processCmd  id "+ id + "   Self:  " + self);
