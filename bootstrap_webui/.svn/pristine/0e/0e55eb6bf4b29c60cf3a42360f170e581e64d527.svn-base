...
function barco_NGSRebootDelay(evt) {
  console.log("barco_NGSRebootDelay ");
...
function barco_ngsStatusHandler() {
  console.log("barco_ngsStatusHandler ");
  ...
  if (barco_ngs_results.length > 0) {
	...
	console.log("OK " +window.location.href);
  	...
  	console.log("REBOOT " +window.location.href);
...
function barco_formResponseGood(response, status) {
  ...
  console.log("barco_formResponseGood  " + barco_ngs_status);
  console.log("barco_formResponseGood  " + barco_ngs_results);
  console.log("barco_modalShowing  " + barco_modalShowing);
...
function barco_formResponseBad(request, status, error) {
  ...
  console.log("barco_formResponseBad  barco_modalShowing " + barco_modalShowing);
