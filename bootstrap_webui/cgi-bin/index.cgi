      ...
      if [ $reconfigure ]; then
        ...
        if [ $bweb_auth_level -ge 1 ]; then
          ...
          if [ -n "$bweb_resource" ]; then
            echo "<html><meta http-equiv=\"refresh\" content=\"3;URL=/cgi-bin/$bweb_resource\"><head></head><body><h3>Not authorized. Please login again.</h3></body></html>"
          else
