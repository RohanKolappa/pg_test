...
// ============================================================================
// 
// This file is part of "VMP::AVC".
// 
// "VMP::AVC" is free software; you can redistribute it and/or modify it
// under the terms of the GNU Lesser General Public License as published
// by the Free Software Foundation; either version 2.1 of the License, or
// (at your option) any later version.
// 
// "VMP::AVC" is distributed in the hope that it will be useful, but
// WITHOUT ANY WARRANTY; without even the implied warranty of
// MERCHANTABILITY or FITNESS FOR A PARTICULAR PURPOSE.  See the GNU
// Lesser General Public License for more details.
// 
// You should have received a copy of the GNU Lesser General Public License
// along with "VMP::AVC"; if not, write to:
...
#ifndef _VMP_AVC_DLL_H_
#define _VMP_AVC_DLL_H_
...
/// \defgroup VMP_AVC VMP::AVC (??? module)
///
...
#if ! defined( VMP_AVC_DLL )
#  if defined( VMP_AVC_EXPORTS )
#    define VMP_AVC_DLL JBS_DLL_EXPORT
#  else
#    define VMP_AVC_DLL JBS_DLL_IMPORT
#  endif
#endif
...
//#include "VMP.AVC.MyClass.h"

// ============================================================================

#endif // _VMP_AVC_DLL_H_
