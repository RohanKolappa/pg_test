...
#ifndef _BFC_Dyn_TBuffer_H_
#define _BFC_Dyn_TBuffer_H_
...
BFC_PTR_DECL( BFC_Dyn_DLL, TBuffer )
...
class BFC_Dyn_DLL TBuffer : public Type {

protected :

	/// \brief Creates a new TBuffer.
