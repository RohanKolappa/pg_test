...
#ifndef _BFC_Dyn_TBool_H_
#define _BFC_Dyn_TBool_H_
...
BFC_PTR_DECL( BFC_Dyn_DLL, TBool )
...
class BFC_Dyn_DLL TBool : public Type {

protected :

	/// \brief Creates a new TBool.
