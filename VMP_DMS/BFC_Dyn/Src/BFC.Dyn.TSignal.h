...
#ifndef _BFC_Dyn_TSignal_H_
#define _BFC_Dyn_TSignal_H_
...
BFC_PTR_DECL( BFC_Dyn_DLL, TSignal )
...
class BFC_Dyn_DLL TSignal : public Type {

protected :

	/// \brief Creates a new TSignal.
