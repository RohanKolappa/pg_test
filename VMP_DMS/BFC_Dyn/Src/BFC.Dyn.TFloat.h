...
#ifndef _BFC_Dyn_TFloat_H_
#define _BFC_Dyn_TFloat_H_
...
BFC_PTR_DECL( BFC_Dyn_DLL, TFloat )
...
class BFC_Dyn_DLL TFloat : public Type {

protected :

	/// \brief Creates a new TFloat.
