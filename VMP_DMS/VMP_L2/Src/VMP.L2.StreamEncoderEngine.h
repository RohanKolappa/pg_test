...
#ifndef _VMP_L2_StreamEncoderEngine_H_
#define _VMP_L2_StreamEncoderEngine_H_
...
#include "VMP.L2.StreamEncoderEnginePtr.h"
...
class VMP_L2_DLL StreamEncoderEngine : public ProxyPushEngine {
...
public :
	...
	/// \brief Creates a new StreamEncoderEngine.
...
private :
	...
	L3::StreamEncoderBackendPtr	backend;
	L3::StreamEncoderODevicePtr	odevice;

	StreamEncoderEngine(
	);

	StreamEncoderEngine(
		const	StreamEncoderEngine &
	);

	StreamEncoderEngine & operator = (
		const	StreamEncoderEngine &
	);
...
#endif // _VMP_L2_StreamEncoderEngine_H_
