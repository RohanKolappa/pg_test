...
// 
// Filename:
//	VMP.L2.PicturesProducerEngine.h
// 
// Description:
//	...
// 
...
#ifndef _VMP_L2_PicturesProducerEngine_H_
#define _VMP_L2_PicturesProducerEngine_H_
...
#include "VMP.L2.PicturesProducerEnginePtr.h"
...
/// \brief ProxyPushEngine wrapping an L3::PicturesProducerBackend.
///
/// \ingroup VMP_L2

class VMP_L2_DLL PicturesProducerEngine : public ProxyPushEngine {
...
public :
	...
	/// \brief Creates a new PicturesProducerEngine.

	PicturesProducerEngine(
			L3::PicturesProducerBackendPtr	backend
	);
...
#endif // _VMP_L2_PicturesProducerEngine_H_
