...
BFC_PTR_IMPL_NS( Crypto, Cast5 )

// ============================================================================

const DL::TypeCPtr & Crypto::Cast5::getClassType() {

	static DL::TypeCPtr i = new DL::Type(
		UUId( "594fee49-ec49-49dc-9ceb-552c1bbba1bf" ),
		"BFC.Crypto.Cast5",
...
Uint32 Crypto::Cast5::getKeySize(
...
void Crypto::Cast5::setKey(
	...
	System::bzero( buf, 16 );
	System::memcpy( buf, key, keylen );

	Uint32 x[4], z[4];

	/* load and start the awful looking network */
	for ( Uint32 y = 0; y < 4; y++) {
		x[3-y] = LOAD32H( buf+4*y );
	}

	for ( Uint32 i = 0, y = 0 ; y < 2 ; y++ ) {
...
void Crypto::Cast5::test() {
	...
	for ( Uint32 x = 0; x < (sizeof(tests)/sizeof(tests[0])); x++) {
		...
		if ( nct != ct
		  || npt != pt ) {
			throw InternalError( "Cast5 failed (pass 1)!" );
		}
		...
		if ( tmp != ct ) {
			throw InternalError( "Cast5 failed (pass 2)!" );
		}
...
const Uint32 Crypto::Cast5::S1[256] = {
...
const Uint32 Crypto::Cast5::S2[256] = {
...
const Uint32 Crypto::Cast5::S3[256] = {
...
const Uint32 Crypto::Cast5::S4[256] = {
...
const Uint32 Crypto::Cast5::S5[256] = {
...
const Uint32 Crypto::Cast5::S6[256] = {
...
const Uint32 Crypto::Cast5::S7[256] = {
...
const Uint32 Crypto::Cast5::S8[256] = {
...
static Crypto::CipherRegisterer< Crypto::Cast5 > cast5Registerer;
