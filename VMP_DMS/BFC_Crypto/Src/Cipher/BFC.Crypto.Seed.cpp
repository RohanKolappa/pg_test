...
BFC_PTR_IMPL_NS( Crypto, Seed )

// ============================================================================

const DL::TypeCPtr & Crypto::Seed::getClassType() {

	static DL::TypeCPtr i = new DL::Type(
		UUId( "99c3d7e2-3f87-4596-bda6-eab7f0f0b58d" ),
		"BFC.Crypto.Seed",
...
void Crypto::Seed::setKey(
	...
	for ( Uint32 i = 0; i < 16; i++) {
		K[2*i+0] = G(k1 + k3 - KCi[i]);
		K[2*i+1] = G(k2 - k4 + KCi[i]);
		if (i&1) {
			tmp = k3;
...
void Crypto::Seed::test() {
	...
	for ( Uint32 x = 0; x < (sizeof(tests)/sizeof(tests[0])); x++) {
		...
		if ( nct != ct
		  || npt != pt ) {
			throw InternalError( "Seed failed (pass 1)!" );
		}
		...
		if ( tmp != ct ) {
			throw InternalError( "Seed failed (pass 2)!" );
		}
...
void Crypto::Seed::rounds(Uint32 *P, Uint32 *K) {
...
const Uint32 Crypto::Seed::SS0[256] = {
...
const Uint32 Crypto::Seed::SS1[256] = {
...
const Uint32 Crypto::Seed::SS2[256] = {
...
const Uint32 Crypto::Seed::SS3[256] = {
...
const Uint32 Crypto::Seed::KCi[16] = {
...
static Crypto::CipherRegisterer< Crypto::Seed > cast5Registerer;
