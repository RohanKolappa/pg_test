...
#ifndef _BFC_MT_EmulMutex_H_
#define _BFC_MT_EmulMutex_H_
...
///
/// See the documentation of the SysMutex class for more information.
///
/// \ingroup BFC_MT

class BFC_MT_DLL EmulMutex : public SysLockable {
...
private :
	...
	friend class EmulCondition;

//#if defined( PLATFORM_WIN3 2)
//	SysSyncEvent		unlocked;
//	Bool			cache;
//#else
	SysMutex		mutex;
//#endif
