...
TBFC_PTR_IMPL_NS( GenDep, PPFileParser )

// ============================================================================

GenDep::PPFileParser::PPFileParser() {
...
GenDep::PPFilePtr GenDep::PPFileParser::parse(
...
//		throw InvalidArgument( filename );
	...
	while ( pos < content.length() ) {
		...
		try {
			...
			cerr << "[WRN] Can't understand line: \""
				<< Buffer( ( const Uchar * )outbuf, outlen ) << "\"!" << endl;
			cerr << e.what() << endl;
		}
	}
...
void GenDep::PPFileParser::readLine(
...
GenDep::DirectivePtr GenDep::PPFileParser::processLine() const {
...
Buffer GenDep::PPFileParser::extractToken(
		Uint32&		pos ) const {
...
Buffer GenDep::PPFileParser::extractRestOfLine(
...
GenDep::ExprPtr GenDep::PPFileParser::buildExpr(
