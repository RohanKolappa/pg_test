...
using namespace TBFC::Light;

// ============================================================================

TBFC_PTR_IMPL( LibConfig )
...
LibConfigPtr LibConfig::instance() {
...
void LibConfig::reload() {

	traceExceptions = Buffer( ::getenv( "TBFC_TRACE_EXCEPTIONS" ) ).toBool();
