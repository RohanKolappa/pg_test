...
#ifndef _TBFC_Base_SPtrHub_H_
#define _TBFC_Base_SPtrHub_H_
...
public :
	...
	///
	/// Nothing is done with the SObject!
	...
	///
	/// \returns True iff the hub should be destroyed by the SObject.
