...
// FIXME: optimize drastically (later) :-)
	...
	if ( mEltLength == 1 ) {
		System::memset( mBlkMinPtr, v, mBlkLength );
	}
...
void Mem::Writer::copyDataFrom(
	...
	if ( reader.getNbrCols() != getNbrCols() ) {
		throw InvalidArgument( "Writer::copyDataFrom(): != cols" );
	}
...
Mem::Univ32Writer::SetTableEntry Mem::Univ32Writer::setTable[] = {
	{
		& Univ32Writer::setStart08,
		& Univ32Writer::setIndex08,
		& Univ32Writer::setXYPos08
	},
	{
		& Univ32Writer::setStart16,
		& Univ32Writer::setIndex16,
		& Univ32Writer::setXYPos16
	},
	{
		& Univ32Writer::setStart24,
		& Univ32Writer::setIndex24,
		& Univ32Writer::setXYPos24
	},
	{
		& Univ32Writer::setStart32,
		& Univ32Writer::setIndex32,
		& Univ32Writer::setXYPos32
	}
};

// ============================================================================

void Mem::Univ32Writer::setStart08(
	const	Uint32		val ) {

	* ( Uchar * )checkAndGetAddr() = ( const Uchar )val;

}

void Mem::Univ32Writer::setStart16(
	const	Uint32		val ) {

	* ( Uint16 * )checkAndGetAddr() = ( const Uint16 )val;

}

void Mem::Univ32Writer::setStart24(
	const	Uint32		val ) {

	* ( Uint24 * )checkAndGetAddr() = ( const Uint24 )val;

}

void Mem::Univ32Writer::setStart32(
	const	Uint32		val ) {

	* ( Uint32 * )checkAndGetAddr() = ( const Uint32 )val;

}

void Mem::Univ32Writer::setIndex08(
	const	Uint32		index,
	const	Uint32		val ) {

	* ( Uchar * )checkAndGetAddr( index ) = ( const Uchar )val;

}

void Mem::Univ32Writer::setIndex16(
	const	Uint32		index,
	const	Uint32		val ) {

	* ( Uint16 * )checkAndGetAddr( index ) = ( const Uint16 )val;

}

void Mem::Univ32Writer::setIndex24(
	const	Uint32		index,
	const	Uint32		val ) {

	* ( Uint24 * )checkAndGetAddr( index ) = ( const Uint24 )val;

}

void Mem::Univ32Writer::setIndex32(
	const	Uint32		index,
	const	Uint32		val ) {

	* ( Uint32 * )checkAndGetAddr( index ) = ( const Uint32 )val;

}

void Mem::Univ32Writer::setXYPos08(
	const	Uint32		x,
	const	Uint32		y,
	const	Uint32		val ) {

	* ( Uchar * )checkAndGetAddr( x, y ) = ( const Uchar )val;

}

void Mem::Univ32Writer::setXYPos16(
	const	Uint32		x,
	const	Uint32		y,
	const	Uint32		val ) {

	* ( Uint16 * )checkAndGetAddr( x, y ) = ( const Uint16 )val;

}

void Mem::Univ32Writer::setXYPos24(
	const	Uint32		x,
	const	Uint32		y,
	const	Uint32		val ) {

	* ( Uint24 * )checkAndGetAddr( x, y ) = ( const Uint24 )val;

}

void Mem::Univ32Writer::setXYPos32(
	const	Uint32		x,
	const	Uint32		y,
	const	Uint32		val ) {

	* ( Uint32 * )checkAndGetAddr( x, y ) = ( const Uint32 )val;
