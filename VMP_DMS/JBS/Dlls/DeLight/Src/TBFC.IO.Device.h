...
#ifndef _TBFC_Light_Device_H_
#define _TBFC_Light_Device_H_
...
TBFC_PTR_DECL( TBFC_Light_DLL, Device )
...
class TBFC_Light_DLL Device : virtual public DObject {
...
public :
	...
	///
	/// If this Device was still connected, it is first flushed, then
	/// closed.
...
public :
	...
	BASE_CLASS_GEN_EXCEPTION("TBFC.IO.Device");
...
TBFC_Light_DLL Device & operator << (
		Device		& dev,
	const	Buffer		& buf
);
