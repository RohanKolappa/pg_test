...
#ifndef _VMP_Filter_H_
#define _VMP_Filter_H_
...
BFC_PTR_DECL( VMP_Libs_Base_DLL, Filter )
...
class VMP_Libs_Base_DLL Filter : virtual public BFC::SObject {
