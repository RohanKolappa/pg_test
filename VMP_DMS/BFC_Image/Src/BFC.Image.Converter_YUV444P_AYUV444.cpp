...
// 
// Filename:
//	BFC.Image.Converter_YUV444P_AYUV444.cpp
// 
// Description:
//	...
// 
...
#include "BFC.Image.Converter_YUV444P_AYUV444.h"
...
Converter_YUV444P_AYUV444::Converter_YUV444P_AYUV444()
	: RawConverter(
		PictureFormat::YUV444P,
		PictureFormat::AYUV444 ) {
...
void Converter_YUV444P_AYUV444::engineForward(
		ReaderArray	& pIPics,	// YUV444P
		WriterArray	& pOPics ) {	// AYUV444
...
void Converter_YUV444P_AYUV444::engineBackward(
		ReaderArray	& pIPics,	// AYUV444
...
static ConverterPtr dummy_YUV444P_AYUV444 = new Converter_YUV444P_AYUV444;
