...
#ifndef _BFC_Light_DLL_H_
#define _BFC_Light_DLL_H_
...
/// \defgroup BFC_Light BFC::Light (Core support module)
///
/// \brief Container group for all the subgroups of the BFC_Light module.
...
#if ! defined( BFC_Light_DLL )
#  if defined( BFC_Light_EXPORTS )
#    define BFC_Light_DLL JBS_DLL_EXPORT
#  else
#    define BFC_Light_DLL JBS_DLL_IMPORT
#  endif
#endif
