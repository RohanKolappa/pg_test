...
#ifndef _BFC_Light_ConsoleColor_H_
#define _BFC_Light_ConsoleColor_H_
...
/// \brief An enumeration of all possible colors displayable on the console.
///
/// \ingroup BFC_Light
...
#endif // _BFC_Light_ConsoleColor_H_
