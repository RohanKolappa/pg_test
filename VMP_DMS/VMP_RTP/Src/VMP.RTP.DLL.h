...
#ifndef _VMP_RTP_DLL_H_
#define _VMP_RTP_DLL_H_
...
/// \defgroup VMP_RTP VMP::RTP (??? module)
///
...
#if ! defined( VMP_RTP_DLL )
#  if defined( VMP_RTP_EXPORTS )
#    define VMP_RTP_DLL JBS_DLL_EXPORT
#  else
#    define VMP_RTP_DLL JBS_DLL_IMPORT
#  endif
#endif
...
//#include "VMP.RTP.MyClass.h"

// ============================================================================

#endif // _VMP_RTP_DLL_H_
