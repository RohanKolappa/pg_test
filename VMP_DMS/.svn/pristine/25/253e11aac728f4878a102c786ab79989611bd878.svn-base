...
#ifndef _VMP_M2S_DescriptorPtr_H_
#define _VMP_M2S_DescriptorPtr_H_
...
BFC_PTR_DECL( VMP_M2S_DLL, Descriptor )
BFC_PTR_DECL( VMP_M2S_DLL, CADescriptor )
...
#endif // _VMP_M2S_DescriptorPtr_H_
