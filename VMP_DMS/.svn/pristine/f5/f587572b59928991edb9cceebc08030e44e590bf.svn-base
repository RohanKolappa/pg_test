...
// 
// Filename:
//	VMP.L2.SimpleProxyPushEngine.cpp
// 
// Description:
//	...
// 
...
BFC_PTR_IMPL_NS( L2, SimpleProxyPushEngine )

// ============================================================================

const DL::TypeCPtr & L2::SimpleProxyPushEngine::getClassType() {

	static DL::TypeCPtr i = new DL::Type(
		UUId( "201f700d-7890-44b1-b8e3-5dc70f2baa66" ),
		"VMP.L2.SimpleProxyPushEngine",
...
L2::SimpleProxyPushEngine::SimpleProxyPushEngine() :
...
void L2::SimpleProxyPushEngine::putSessionCallback(
		SessionPtr	pSession ) {
...
void L2::SimpleProxyPushEngine::endSessionCallback() {
...
void L2::SimpleProxyPushEngine::putFrameCallback(
		FramePtr	pFrame ) {
...
void L2::SimpleProxyPushEngine::flushSessionCallback() {
...
static L2::EngineRegisterer< L2::SimpleProxyPushEngine > registerer;
