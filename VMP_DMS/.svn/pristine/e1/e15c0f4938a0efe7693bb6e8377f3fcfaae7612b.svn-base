...
#ifndef _VMP_HLS_DLL_H_
#define _VMP_HLS_DLL_H_
...
/// \defgroup VMP_HLS VMP::HLS (??? module)
///
...
#if ! defined( VMP_HLS_DLL )
#  if defined( VMP_HLS_EXPORTS )
#    define VMP_HLS_DLL JBS_DLL_EXPORT
#  else
#    define VMP_HLS_DLL JBS_DLL_IMPORT
#  endif
#endif
...
//#include "VMP.HLS.MyClass.h"

// ============================================================================

#endif // _VMP_HLS_DLL_H_
