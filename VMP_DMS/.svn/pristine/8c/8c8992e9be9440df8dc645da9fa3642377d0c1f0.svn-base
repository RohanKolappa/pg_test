...
#ifndef _BFC_DOM_Config_H_
#define _BFC_DOM_Config_H_
...
/// \brief Represents a DOM Configuration.
///
...
class BFC_DOM_DLL Config : virtual public SObject {
...
/// true if the parameter could be successfully set to the specified value, or false if the parameter is not recognized or the requested value is not supported. This does not change the current value of the parameter itself.
	...
	virtual Bool canSetParameter(
		const	Buffer &	name, 
			SPtr		value
	) const = 0;

	/// \brief Returns the list of the parameters supported by this DOMConfiguration object and for which at least one value can be set by the application. Note that this list can also contain parameter names defined outside this specification.
	virtual const BufferArray & getParameterNames(
	) const = 0;
