...
#ifndef _VMP_L3_MuxedDecoderBackend_H_
#define _VMP_L3_MuxedDecoderBackend_H_
...
BFC_PTR_DECL( VMP_L3_DLL, MuxedDecoderBackend )
...
/// \brief Base class of all mux decoder backends.
///
/// \ingroup VMP_L3

class VMP_L3_DLL MuxedDecoderBackend : public StreamDecoderBackend {
...
protected :
	...
	/// \brief Creates a new MuxedDecoderBackend.
...
#endif // _VMP_L3_MuxedDecoderBackend_H_
