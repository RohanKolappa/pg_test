...
BFC_PTR_IMPL_NS( Crypto, Blowfish )

// ============================================================================

const DL::TypeCPtr & Crypto::Blowfish::getClassType() {

	static DL::TypeCPtr i = new DL::Type(
		UUId( "657607c9-19d4-4374-a3f0-4dd6730474cc" ),
		"BFC.Crypto.Blowfish",
...
void Crypto::Blowfish::setKey(
	...
	Buffer	B = Buffer::chars( 8, 0x00 );

	for (x = 0; x < 18; x += 2) {
		/* encrypt it */
		encrypt( B, B );
		/* copy it */
		const Uchar *	ptr = B.getCstPtr();
		K[ x     ] = LOAD32H( ptr     );
		K[ x + 1 ] = LOAD32H( ptr + 4 );
	}
...
const Uint32 Crypto::Blowfish::ORIG_P[16 + 2] = {
...
const Uint32 Crypto::Blowfish::ORIG_S[4][256] = {
...
static Crypto::CipherRegisterer< Crypto::Blowfish > blowfishRegisterer;
