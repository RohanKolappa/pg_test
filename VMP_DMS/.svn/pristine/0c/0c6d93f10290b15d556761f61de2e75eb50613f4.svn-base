...
void FSPath::append(
	...
	if ( ! isValid() ) {
		throw InvalidArgument( "Not valid in append(" + cmpt + ")" );
	}
...
void FSPath::append(
	...
	if ( ! isValid() ) {
		throw InvalidArgument( "Not valid in append(" + path.toBuffer() + ")" );
	}
...
void FSPath::removeLast() {
	...
	if ( ! isValid() ) {
		throw InvalidArgument( "Not valid in removeLast()" );
	}
...
void FSPath::forceAbsolute() {
	...
	if ( ! isValid() ) {
		throw InvalidArgument( "Not valid in forceAbsolute()" );
	}
...
const Buffer& FSPath::getLastComponent() const {
	...
	if ( ! isValid() ) {
		throw InvalidArgument( "Not valid in getLastComponent()" );
	}
...
void FSPath::replaceLastComponent(
	...
	if ( ! isValid() ) {
		throw InvalidArgument( "Not valid in replaceLastComponent( " + p + " );" );
	}
...
FSPath FSPath::getDirPath() const {
	...
	if ( ! isValid() ) {
		throw InvalidArgument( "Not valid in getDirPath()" );
	}
...
FSPath FSPath::getFirst(
	...
	if ( ! isValid() ) {
		throw InvalidArgument( "Not valid!" );
	}
...
Buffer FSPath::getBaseName(
	...
	if ( ! isValid() ) {
		throw InvalidArgument( "Not valid in getBaseName()" );
	}
...
const Buffer& FSPath::toBuffer() const {
	...
	if ( ! isValid() ) {
		throw InvalidArgument( "Not valid in toBuffer()" );
	}
...
FSPath FSPath::getCurrentPath() {

	return FSPath( FSDir::getCurrentDir() );

}

FSPath FSPath::getHomePath() {

	return FSPath( FSDir::getHomeDir() );

}

FSPath FSPath::getRootPath() {

	return FSPath( FSDir::getRootDir() );
