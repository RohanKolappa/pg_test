...
#include "BFC.Crypto.RIPEMD160.h"
...
BFC_PTR_IMPL_NS( Crypto, RIPEMD160 )

// ============================================================================

const DL::TypeCPtr & Crypto::RIPEMD160::getClassType() {

	static DL::TypeCPtr i = new DL::Type(
		UUId( "e5609261-37d0-40c5-87f7-f43933b51949" ),
		"BFC.Crypto.RIPEMD160",
...
void Crypto::RIPEMD160::compress(
	const	Uchar *		buf ) {

	Uint32 aa,bb,cc,dd,ee,aaa,bbb,ccc,ddd,eee,X[16];
	Uint32	i;
...
static Crypto::HashRegisterer< Crypto::RIPEMD160 > rmd160Registerer;
