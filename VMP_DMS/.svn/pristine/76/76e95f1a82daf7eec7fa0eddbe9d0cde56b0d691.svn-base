...
#ifndef _VMP_M2S_PESPacketWriterPtr_H_
#define _VMP_M2S_PESPacketWriterPtr_H_
...
BFC_PTR_DECL( VMP_M2S_DLL, PESPacketWriter )
...
#endif // _VMP_M2S_PESPacketWriterPtr_H_
