...
BFC_PTR_IMPL_NS( Crypto, ECB )

// ============================================================================

const DL::TypeCPtr & Crypto::ECB::getClassType() {

	static DL::TypeCPtr i = new DL::Type(
		UUId( "7446484f-20ac-4bce-a4e1-a4ab7e0bbef8" ),
		"BFC.Crypto.ECB",
...
Buffer Crypto::ECB::encrypt(
	...
	for ( Uint32 i = 0 ; i < len ; i += blkSze ) {
		res += cipher->encrypt( pPlainText( i, blkSze ) );
	}
...
Buffer Crypto::ECB::decrypt(
	...
	for ( Uint32 i = 0 ; i < len ; i += blkSze ) {
		res += cipher->decrypt( pCipherText( i, blkSze ) );
	}
...
Buffer Crypto::ECB::getiv() const {

	return Buffer();

}

void Crypto::ECB::setiv(
	const	Buffer &	/* pIV */ ) {
...
static Crypto::ModeRegisterer< Crypto::ECB > ecbRegisterer;
