...
// 
// Filename:
//	VMP.RTP.TJitterRemoverEngine.h
// 
// Description:
//	...
// 
...
#ifndef _VMP_RTP_TJitterRemoverEngine_H_
#define _VMP_RTP_TJitterRemoverEngine_H_
...
#include "VMP.RTP.TJitterRemoverEnginePtr.h"
...
class VMP_RTP_DLL TJitterRemoverEngine : public L2::ProxyPushEngine {
...
public :
	...
	/// \brief Creates a new TJitterRemoverEngine.
...
private :
	...
	TConvexCurvePtr			convCurv;
	BFC::Time::Clock		prevCorr;

	/// \brief Forbidden copy constructor.

	TJitterRemoverEngine(
		const	TJitterRemoverEngine &
	);

	/// \brief Forbidden copy operator.

	TJitterRemoverEngine & operator = (
		const	TJitterRemoverEngine &
	);
...
#endif // _VMP_RTP_TJitterRemoverEngine_H_
