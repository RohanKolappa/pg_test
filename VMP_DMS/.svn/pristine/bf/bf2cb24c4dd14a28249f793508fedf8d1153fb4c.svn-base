...
BFC_PTR_IMPL_NS( L3, EncoderBackend )

// ============================================================================

const DL::TypeCPtr & L3::EncoderBackend::getClassType() {

	static DL::TypeCPtr i = new DL::Type(
		UUId( "b3eeb417-39b7-4e6e-b0d0-43ba16793b7f" ),
		"VMP.L3.EncoderBackend",
