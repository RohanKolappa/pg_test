...
// ============================================================================
// 
// This file is part of "VMP::AAC".
// 
// "VMP::AAC" is free software; you can redistribute it and/or modify it
// under the terms of the GNU Lesser General Public License as published
// by the Free Software Foundation; either version 2.1 of the License, or
// (at your option) any later version.
// 
// "VMP::AAC" is distributed in the hope that it will be useful, but
// WITHOUT ANY WARRANTY; without even the implied warranty of
// MERCHANTABILITY or FITNESS FOR A PARTICULAR PURPOSE.  See the GNU
// Lesser General Public License for more details.
// 
// You should have received a copy of the GNU Lesser General Public License
// along with "VMP::AAC"; if not, write to:
...
#ifndef _VMP_AAC_DLL_H_
#define _VMP_AAC_DLL_H_
...
/// \defgroup VMP_AAC VMP::AAC (??? module)
///
...
#if ! defined( VMP_AAC_DLL )
#  if defined( VMP_AAC_EXPORTS )
#    define VMP_AAC_DLL JBS_DLL_EXPORT
#  else
#    define VMP_AAC_DLL JBS_DLL_IMPORT
#  endif
#endif
...
//#include "VMP.AAC.MyClass.h"

// ============================================================================

#endif // _VMP_AAC_DLL_H_
