...
#ifndef _BFC_TL_ListTmpl_H_
#define _BFC_TL_ListTmpl_H_
...
public :
	...
	/// \brief Returns element \a i of the list.
...
template < typename T >
const T& ListTmpl< T >::operator [] (const Uint32 i) const {

	ListCell *ptr = privGetFirst();
...
template < typename T >
T& ListTmpl< T >::operator [] (const Uint32 i) {
