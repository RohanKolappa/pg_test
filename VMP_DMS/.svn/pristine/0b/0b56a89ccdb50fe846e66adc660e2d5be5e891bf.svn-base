...
#ifndef _VMP_L3_AudioEncoderBackend_H_
#define _VMP_L3_AudioEncoderBackend_H_
...
BFC_PTR_DECL( VMP_L3_DLL, AudioEncoderBackend )
...
/// \brief Base class of all audio encoder backends.
///
/// \ingroup VMP_L3_Audio

class VMP_L3_DLL AudioEncoderBackend : public StreamEncoderBackend {
...
protected :
	...
	/// \brief Creates a new AudioEncoderBackend.
...
#endif // _VMP_L3_AudioEncoderBackend_H_
