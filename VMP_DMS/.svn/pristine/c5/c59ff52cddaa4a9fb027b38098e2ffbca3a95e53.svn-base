...
#ifndef _TBFC_Mem_Writer_H_
#define _TBFC_Mem_Writer_H_
...
public :
	...
	BASE_CLASS_GEN_EXCEPTION( "TBFC.Mem.Writer" );
...
class TBFC_Light_DLL UcharWriter : public Writer {
...
public :
	...
	Uchar & operator () (
		...
		return * ( Uchar * )checkAndGetAddr( x, y );
	}
...
class TBFC_Light_DLL Uint16Writer : public Writer {
...
public :
	...
	Uint16 & operator () (
		...
		return * ( Uint16 * )checkAndGetAddr( x, y );
	}
...
class TBFC_Light_DLL Uint24Writer : public Writer {
...
//	}
	...
	Uint24 & operator () (
		...
		return * ( Uint24 * )checkAndGetAddr( x, y );
	}
...
class TBFC_Light_DLL Uint32Writer : public Writer {
...
public :
	...
	Uint32 & operator () (
		...
		return * ( Uint32 * )checkAndGetAddr( x, y );
	}
...
class TBFC_Light_DLL Univ32Writer : public Writer {
...
protected :
	...
	typedef void ( Univ32Writer::*SetStartMethodType )(
			const	Uint32		val
		);
	typedef void ( Univ32Writer::*SetIndexMethodType )(
			const	Uint32		index,
			const	Uint32		val
		);
	typedef void ( Univ32Writer::*SetXYPosMethodType )(
			const	Uint32		x,
			const	Uint32		y,
			const	Uint32		val
		);

	void setStart08( const Uint32 val );
	void setStart16( const Uint32 val );
	void setStart24( const Uint32 val );
	void setStart32( const Uint32 val );

	void setIndex08( const Uint32 index, const Uint32 val );
	void setIndex16( const Uint32 index, const Uint32 val );
	void setIndex24( const Uint32 index, const Uint32 val );
	void setIndex32( const Uint32 index, const Uint32 val );

	void setXYPos08( const Uint32 x, const Uint32 y, const Uint32 val );
	void setXYPos16( const Uint32 x, const Uint32 y, const Uint32 val );
	void setXYPos24( const Uint32 x, const Uint32 y, const Uint32 val );
	void setXYPos32( const Uint32 x, const Uint32 y, const Uint32 val );
...
class TBFC_Light_DLL Uint64Writer : public Writer {
...
public :
	...
	Uint64 & operator () (
		...
		return * ( Uint64 * )checkAndGetAddr( x, y );
	}
