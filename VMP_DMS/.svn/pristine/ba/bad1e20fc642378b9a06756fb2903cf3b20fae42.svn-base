...
#ifndef _VMP_L3_DecoderBackend_H_
#define _VMP_L3_DecoderBackend_H_
...
BFC_PTR_DECL( VMP_L3_DLL, DecoderBackend )
...
class VMP_L3_DLL DecoderBackend : public Backend {
...
#endif // _VMP_L3_DecoderBackend_H_
