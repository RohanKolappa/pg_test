...
#include "BFC.Crypto.RIPEMD320.h"
...
BFC_PTR_IMPL_NS( Crypto, RIPEMD320 )

// ============================================================================

const DL::TypeCPtr & Crypto::RIPEMD320::getClassType() {

	static DL::TypeCPtr i = new DL::Type(
		UUId( "d39d6c63-ea36-4524-be26-488f77e9e562" ),
		"BFC.Crypto.RIPEMD320",
...
void Crypto::RIPEMD320::compress(
	const	Uchar *		buf ) {

	Uint32 aa,bb,cc,dd,ee,aaa,bbb,ccc,ddd,eee,tmp,X[16];
	Uint32 i;
...
static Crypto::HashRegisterer< Crypto::RIPEMD320 > rmd320Registerer;
