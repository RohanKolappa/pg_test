...
#ifndef _VMP_M2S_PSDecoderBackendPtr_H_
#define _VMP_M2S_PSDecoderBackendPtr_H_
...
BFC_PTR_DECL( VMP_M2S_DLL, PSDecoderBackend )
...
#endif // _VMP_M2S_PSDecoderBackendPtr_H_
