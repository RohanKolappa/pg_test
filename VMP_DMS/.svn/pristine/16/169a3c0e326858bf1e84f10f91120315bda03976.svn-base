...
#ifndef _BFC_Image_Converter_Bayer_H_
#define _BFC_Image_Converter_Bayer_H_
...
class BFC_Image_DLL Converter_RGB_GBRG : public Converter {

public :

	/// \brief Creates a new Converter_RGB_GBRG.
...
#endif // _BFC_Image_Converter_Bayer_H_
