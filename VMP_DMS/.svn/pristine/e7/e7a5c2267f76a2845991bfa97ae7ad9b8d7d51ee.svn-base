...
#ifndef _VMP_L3_VideoDecoderBackend_H_
#define _VMP_L3_VideoDecoderBackend_H_
...
BFC_PTR_DECL( VMP_L3_DLL, VideoDecoderBackend )
...
/// \brief Base class of all video decoder backends.
///
/// \ingroup VMP_L3

class VMP_L3_DLL VideoDecoderBackend : public StreamDecoderBackend {
...
protected :
	...
	/// \brief Creates a new VideoDecoderBackend.
...
#endif // _VMP_L3_VideoDecoderBackend_H_
