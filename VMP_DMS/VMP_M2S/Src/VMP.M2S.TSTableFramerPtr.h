...
#ifndef _VMP_M2S_TSTableFramerPtr_H_
#define _VMP_M2S_TSTableFramerPtr_H_
...
BFC_PTR_DECL( VMP_M2S_DLL, TSTableFramer )
...
#endif // _VMP_M2S_TSTableFramerPtr_H_
