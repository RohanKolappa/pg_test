...
#ifndef _VMP_M2S_DLL_H_
#define _VMP_M2S_DLL_H_
...
/// \defgroup VMP_M2S VMP::M2S (MPEG-2 System module)
///
...
#if ! defined( VMP_M2S_DLL )
#  if defined( VMP_M2S_EXPORTS )
#    define VMP_M2S_DLL JBS_DLL_EXPORT
#  else
#    define VMP_M2S_DLL JBS_DLL_IMPORT
#  endif
#endif
...
//#include "VMP::M2S.MyClass.h"

// ============================================================================

#endif // _VMP_M2S_DLL_H_
