...
#ifndef _VMP_M2S_PESPacketFramerPtr_H_
#define _VMP_M2S_PESPacketFramerPtr_H_
...
BFC_PTR_DECL( VMP_M2S_DLL, PESPacketFramer )
...
#endif // _VMP_M2S_PESPacketFramerPtr_H_
