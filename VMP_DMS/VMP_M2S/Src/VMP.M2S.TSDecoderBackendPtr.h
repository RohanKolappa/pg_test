...
#ifndef _VMP_M2S_TSDecoderBackendPtr_H_
#define _VMP_M2S_TSDecoderBackendPtr_H_
...
BFC_PTR_DECL( VMP_M2S_DLL, TSDecoderBackend )
...
#endif // _VMP_M2S_TSDecoderBackendPtr_H_
