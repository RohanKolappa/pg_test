...
// ============================================================================
// 
// This file is part of "BFC::XML".
// 
// "BFC::XML" is free software; you can redistribute it and/or modify it
// under the terms of the GNU Lesser General Public License as published
// by the Free Software Foundation; either version 2.1 of the License, or
// (at your option) any later version.
// 
// "BFC::XML" is distributed in the hope that it will be useful, but
// WITHOUT ANY WARRANTY; without even the implied warranty of
// MERCHANTABILITY or FITNESS FOR A PARTICULAR PURPOSE.  See the GNU
// Lesser General Public License for more details.
// 
// You should have received a copy of the GNU Lesser General Public License
// along with "BFC::XML"; if not, write to:
...
#ifndef _BFC_XML_DLL_H_
#define _BFC_XML_DLL_H_
...
/// \defgroup BFC_XML BFC::XML (??? module)
///
...
#if ! defined( BFC_XML_DLL )
#  if defined( BFC_XML_EXPORTS )
#    define BFC_XML_DLL JBS_DLL_EXPORT
#  else
#    define BFC_XML_DLL JBS_DLL_IMPORT
#  endif
#endif
...
//#include "BFC.XML.MyClass.h"

// ============================================================================

#endif // _BFC_XML_DLL_H_
