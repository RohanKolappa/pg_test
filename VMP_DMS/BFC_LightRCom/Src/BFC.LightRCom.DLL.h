...
#ifndef _BFC_LightRCom_DLL_H_
#define _BFC_LightRCom_DLL_H_
...
/// \defgroup BFC_LightRCom BFC::LightRCom (??? module)
///
...
#if ! defined( BFC_LightRCom_DLL )
#  if defined( BFC_LightRCom_EXPORTS )
#    define BFC_LightRCom_DLL JBS_DLL_EXPORT
#  else
#    define BFC_LightRCom_DLL JBS_DLL_IMPORT
#  endif
#endif
...
//#include "BFC.LightRCom.MyClass.h"

// ============================================================================

#endif // _BFC_LightRCom_DLL_H_
