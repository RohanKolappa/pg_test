...
BFC_PTR_IMPL_NS( L3, BackendFactory )

// ============================================================================

L3::BackendPtr L3::BackendFactory::getNewBackend() {

	return getNewUObject();
...
L3::BackendPtr L3::BackendFactory::getNewBackend(
	...
	return getNewUObject( pToolkit, pParent );
