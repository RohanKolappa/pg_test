...
#ifndef _VMP_L3_VideoEncoderBackend_H_
#define _VMP_L3_VideoEncoderBackend_H_
...
BFC_PTR_DECL( VMP_L3_DLL, VideoEncoderBackend )
...
/// \brief Base class of all video encoder backends.
///
/// \ingroup VMP_L3

class VMP_L3_DLL VideoEncoderBackend : public StreamEncoderBackend {
...
protected :
	...
	/// \brief Creates a new VideoEncoderBackend.
...
#endif // _VMP_L3_VideoEncoderBackend_H_
