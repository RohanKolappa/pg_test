...
BFC_PTR_IMPL_NS( Msg, Consumer )

// ============================================================================

Msg::Consumer::Consumer() {

	consId = Dispatcher::instance()->addConsumer( this );

}

Msg::Consumer::~Consumer() {

	Dispatcher::instance()->delConsumer( consId );

}

// ============================================================================

void Msg::Consumer::disconnect() {

	Dispatcher::instance()->disconnectConsumer( consId );
