...
#ifndef _BFC_Net_IPv6Addr_H_
#define _BFC_Net_IPv6Addr_H_
...
BFC_PTR_DECL( BFC_Net_DLL, IPv6Addr )
 ...
 * {@link java.net.NetIface#getName()} for the particular interface in question.
 * When an Inet6Address is created in this way, the numeric scope-id is determined at the time
 * the object is created by querying the relevant NetIface.</li>
 * </ol><p>
 * Note also, that the numeric <i>scope_id</i> can be retrieved from Inet6Address instances returned from the
 * NetIface class. This can be used to find out the current scope ids configured on the system.
 * @since 1.4
 */

/// \ingroup BFC_Net

class BFC_Net_DLL IPv6Addr : public IPAddr {

public :

	/// \brief Creates a new IPv6Addr.
...
//	 */
//	private transient NetIface scope_ifname = null;
//
//	/**
...
//	 */
//	IPv6Addr(Buffer hostName, byte addr[], int scope_id) {
...
//	}
//
//	IPv6Addr(Buffer hostName, byte addr[]) {
//		try {
//			initif (hostName, addr, null);
//		} catch (UnknownHostException e) {} /* cant happen if ifname is null */
//	}
//
//	IPv6Addr (Buffer hostName, byte addr[], NetIface nif) throws UnknownHostException {
...
//	/**
//	 * Create an IPv6Addr in the exact manner of {@link IPAddr#createNew(Buffer,byte[])}
...
//	 * See <a href="IPv6Addr.html#scoped">here</a> for a description of IPv6
//	 * scoped addresses.
//	 *
//	 * @param host the specified host
//	 * @param addr the raw IP address in network byte order
//	 * @param nif an interface this address must be associated with.
//	 * @return  an IPv6Addr object created from the raw IP address.
...
//	 */
//
//	public static IPv6Addr createNew(Buffer host, byte[] addr, NetIface nif)
...
//		}
//		if (addr != null) {
//			if (addr.length == IPv6Addr.INADDRSZ) {
//				return new IPv6Addr(host, addr, nif);
//			}
//		}
...
//	 */
//
//	public static IPv6Addr createNew(Buffer host, byte[] addr, int scope_id)
//		throws UnknownHostException {
//		if (host != null && host.length() > 0 && host.charAt(0) == '[') {
//			if (host.charAt(host.length()-1) == ']') {
//				host = host.substring(1, host.length() -1);
...
//		if (addr != null) {
//			if (addr.length == IPv6Addr.INADDRSZ) {
//				return new IPv6Addr(host, addr, scope_id);
//			}
//		}
//		throw new UnknownHostException("addr is of illegal length");
//	}
...
//	 */
//	private boolean differentLocalAddressTypes(IPv6Addr other) {
//
//		if (isLinkLocal() && !other.isLinkLocal()) {
//			return false;
//		}
//		if (isSiteLocal() && !other.isSiteLocal()) {
//			return false;
//		}
//		return true;
//	}
//
//	private int deriveNumericScope (NetIface ifc) throws UnknownHostException {
//		Enumeration addresses = ifc.getInetAddresses();
//		while (addresses.hasMoreElements()) {
//			IPAddr address = (IPAddr)addresses.nextElement();
//			if (!(address instanceof IPv6Addr)) {
//				continue;
//			}
//			IPv6Addr ia6_addr = (IPv6Addr)address;
...
//	}
//
//	private int deriveNumericScope (Buffer ifname) throws UnknownHostException {
//		Enumeration en;
//		try {
//			en = NetIface.getNetworkInterfaces();
//		} catch (SocketException e) {
//			throw new UnknownHostException ("could not enumerate local network interfaces");
//		}
//		while (en.hasMoreElements()) {
//			NetIface ifc = (NetIface)en.nextElement();
...
//			try {
//				scope_ifname = NetIface.getByName(ifname);
//				try {
...
//
//	/**
//	 * Utility routine to check if the IPAddr is an IP multicast
//	 * address. 11111111 at the start of the address identifies the
//	 * address as being a multicast address.
//	 *
//	 * @return a <code>boolean</code> indicating if the IPAddr is
...
//
//	/**
//	 * Utility routine to check if the IPAddr in a wildcard address.
...
//
//	/**
//	 * Utility routine to check if the IPAddr is a loopback address.
//	 *
//	 * @return a <code>boolean</code> indicating if the IPAddr is
...
//
//	/**
//	 * Utility routine to check if the IPAddr is an link local address.
//	 *
//	 * @return a <code>boolean</code> indicating if the IPAddr is
...
//
//	/**
//	 * Utility routine to check if the IPAddr is a site local address.
//	 *
//	 * @return a <code>boolean</code> indicating if the IPAddr is
...
//
//	/**
//	 * Returns the raw IP address of this <code>IPAddr</code>
//	 * object. The result is in network byte order: the highest order
//	 * byte of the address is in <code>getRawAddr()[0]</code>.
//	 *
//	 * @return  the raw IP address of this object.
//	 */
//	public byte[] getRawAddr() {
...
//	 * @since 1.5
//	 */
//	 public NetIface getScopedInterface () {
//		return scope_ifname;
//	 }
...
//	 * this object.
//	 * <p>
//	 * Two instances of <code>IPAddr</code> represent the same IP
//	 * address if the length of the byte arrays returned by
//	 * <code>getRawAddr</code> is the same for both, and each of the
//	 * array components is the same for the byte arrays.
//	 *
//	 * @param   obj   the object to compare against.
//	 * @return  <code>true</code> if the objects are the same;
//	 *		  <code>false</code> otherwise.
//	 * @see	 java.net.IPAddr#getRawAddr()
//	 */
//	public boolean equals(Object obj) {
//		if (obj == null ||
//			!(obj instanceof IPv6Addr))
//			return false;
//
//		IPv6Addr inetAddr = (IPv6Addr)obj;
//
//		for (int i = 0; i < INADDRSZ; i++) {
...
//
//	/**
//	 * Utility routine to check if the IPAddr is an
...
//	 * @return a Buffer representing an IPv6 address in
//	 *		 textual representation format
//	 * @since 1.4
//	 */
//	static Buffer numericToTextFormat(byte[] src)
//	{
...
//	 */
//	private Buffer ifname;
//
//	/**
//	 * default behavior is overridden in order to write the
//	 * scope_ifname field as a Buffer, rather than a NetIface
