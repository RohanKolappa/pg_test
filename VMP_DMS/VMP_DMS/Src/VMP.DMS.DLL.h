...
#ifndef _VMP_DMS_DLL_H_
#define _VMP_DMS_DLL_H_
...
/// \defgroup VMP_DMS VMP::DMS (??? module)
///
...
#if ! defined( VMP_DMS_DLL )
#  if defined( VMP_DMS_EXPORTS )
#    define VMP_DMS_DLL JBS_DLL_EXPORT
#  else
#    define VMP_DMS_DLL JBS_DLL_IMPORT
#  endif
#endif
...
//#include "VMP.DMS.MyClass.h"

// ============================================================================

#endif // _VMP_DMS_DLL_H_
