#!/bin/sh
#-DipvsAppName=sednanativedbtest  existdbtest sednaxmldbtest bulkupload
...
IPVSCOMPONENT_APP_NAME=bulkupload
...
TESTDBXML=$3
if [ -z ${TESTDBXML} ] ; then
	TESTDBXML="bulkupload.xml"
fi

ARGUMENTS="-bulkuploadxml=${TESTDBXML}  "
