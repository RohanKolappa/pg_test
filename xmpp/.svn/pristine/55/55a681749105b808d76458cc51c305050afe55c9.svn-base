...
public class JID implements Comparable, Serializable {
     private static final long serialVersionUID = 3501009480727228266L;
    ...
    private static Map<String, Object> stringprepCache = Collections.synchronizedMap(new Cache(1000));
    ...
    private static class Cache extends LinkedHashMap<String, Object> {
        private static final long serialVersionUID = 7340510279896249261L;
        private int maxSize;
