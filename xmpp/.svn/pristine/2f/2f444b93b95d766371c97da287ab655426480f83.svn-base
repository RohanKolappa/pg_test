...
public class ExportXmlsFromDBTag extends MigrationTagImpl {

    public ExportXmlsFromDBTag() {
        super("ExportXmlsFromDatabaseTag");
    }

    public ExportXmlsFromDBTag(String moduleName) {
        super(moduleName);
    }
    ...
    public void doMigration(ScriptVariables variables) throws Exception {
        ...
        log("ExportXmlsFromDatabase " + directory.getAbsolutePath());
