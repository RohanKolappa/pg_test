#!/bin/sh
#-DipvsAppName=sednanativedbtest  existdbtest sednaxmldbtest bulkupload dbmigration
...
IPVSCOMPONENT_APP_NAME=dbmigration
...
TESTDBXML=$3
if [ -z ${TESTDBXML} ] ; then
	TESTDBXML="dbmigration.xml"
fi

ARGUMENTS="-dbmigrationxml=${TESTDBXML}  "
