...
public class StringUtils {
    ...
    public synchronized static final String hash(String data) {
        if (digest == null) {
            try {
                ...
                MRLog.error("Failed to load the SHA-1 MessageDigest. " + "Jive will be unable to function normally.");
            }
        }
        // Now, compute hash.
        try {
    ...
    private static final String cvt = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz" + "0123456789+/";
