...
public class JettyServer {
    ...
    public void configPorts(String bindInterface, int adminPort, int adminSecurePort) throws Exception {
        try {
            this.adminPort = adminPort;//IpvsServGlobals.getXMLProperty(getIpvsModuleName() + ".port", 9190);
            this.adminSecurePort = adminSecurePort;//IpvsServGlobals.getXMLProperty(getIpvsModuleName() + "securePort", 9191);
    ...
    public void createRootWebAppContext(String path, String welcomepage) {
        Context context;
    ...
    public void setBaseContext(File pluginsDir, String pluginName) throws Exception {
        try {
            //File pluginsDir = new File(IpvsServGlobals.getPluginsDir());
            //pluginDir = new File(pluginsDir, "admin");
            pluginDir = new File(pluginsDir, pluginName);
    ...
    private String getIpvsModuleName() {
