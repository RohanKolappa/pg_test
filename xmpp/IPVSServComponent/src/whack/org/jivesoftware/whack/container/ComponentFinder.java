...
public class ComponentFinder {
        ...
        try {
            ...
            if (componentConfig.exists()) {
                ...
                if (adminElement != null) {
                    ...
                    imageEl = (Element) adminElement.selectSingleNode("/component/adminconsole/global/login-image");
                    if (imageEl != null) {
                        imageEl.setText("components/" + componentDir.getName() + "/" + imageEl.getText());
                    }
    ...
    public void unloadComponent(String componentName) {
        ...
        File webXML = new File(componentDirectory + File.separator + componentName + File.separator + "web" + File.separator + "web.xml");
        if (webXML.exists()) {
            ...
            try {
                ...
                for (int i = 0; i < jars.length; i++) {
                    ...
                    // needs to be unloaded and then reloaded.
                        ...
                        System.gc();
                        while (!deleteDir(dir)) {
                            manager.getLog().error("Error unloading component " + componentName + ". " + "Will attempt again momentarily.");
                            Thread.sleep(5000);
                        }
