...
public class ServerContainer {
    ...
    public static void main(String[] args) {
        if (args.length < 2) {
            MRLog.error("Usage ServerContainer <absolute path to home folder> <config filename>");
            return;
        }
