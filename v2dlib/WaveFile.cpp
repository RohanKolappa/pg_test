...
// Note: Macros defined by myself
#define DXUT_ERR(ErrMsg, ErrCode) (ErrCode)
...
CWaveFile::CWaveFile()
{
    ...
    if (FAILED(hr))
    {
        (void)DXUT_ERR( L"CoInitializeEx", E_FAIL );
    }
}
...
// Need to implement this class for the MinGW case
CWaveFile::CWaveFile()
{
}
