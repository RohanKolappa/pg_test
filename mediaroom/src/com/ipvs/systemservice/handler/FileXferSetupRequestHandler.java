...
public class FileXferSetupRequestHandler implements MRRequestHandlerI {
  ...
  public Document getResponse(MRRequest request, XMPPI xmpp, MRLog log, MRDB db,
	...
	clientJID = MRXMLUtils.getValueXpath(requestDoc, "//toAgentJID", "");
	...
	ServiceAgentUtils.sendAgentRequestMessage(xmpp, log, SystemServiceConst.FILETRANSFERAGENT, null, clientJID, SystemServiceConst.FILETRANSFERAGENT, 
			requestDoc, 
			"FileXferSetupRequestHandler: Sending FileTransferRequest from " + SystemServiceConst.FILETRANSFERAGENT + " to " + SystemServiceConst.FILETRANSFERAGENT, 
