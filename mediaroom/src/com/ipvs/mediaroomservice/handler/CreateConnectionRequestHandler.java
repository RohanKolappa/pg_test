...
public class CreateConnectionRequestHandler implements MRRequestHandlerI {
	...
	public Document getResponse(MRRequest request,XMPPI xmpp, MRLog log, MRDB db, 
		...
		return ConnectionUtils.CreateConnection(request, xmpp, log, db, resourceFactory, serviceAgentFactory, "CreateConnectionRequest", MediaRoomServiceConst.CONNECTION);
	}
