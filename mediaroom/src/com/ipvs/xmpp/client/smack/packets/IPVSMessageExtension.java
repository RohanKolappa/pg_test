...
public class IPVSMessageExtension implements PacketExtension {

    public static final String IPVS_AGENTMESSAGE_XMLNS = "com.barco.agentmessage";
    public static final String DEPRECATED_IPVS_AGENTMESSAGE_XMLNS = "com.ipvs.agentmessage";
    ...
    public IPVSMessageExtension(String namespace) {
