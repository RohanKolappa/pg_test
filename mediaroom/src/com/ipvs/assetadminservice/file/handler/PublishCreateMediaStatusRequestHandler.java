...
public class PublishCreateMediaStatusRequestHandler extends BasePublishFileRequestHandler implements MRRequestHandlerI{
	...
	public Document getResponse(MRRequest request, XMPPI xmpp, MRLog log,
		...
		for (Object object : listOfFiles) {
			...
			addOrUpdateFile(request, xmpp, log, db, resourceFactory, serviceAgentFactory, responseDoc, resourceDoc, fileEl, groupsFileCache);
		}
		return responseDoc;
	}
}
