...
public class RepairMediaStreamFileRequestHandler implements MRRequestHandlerI {
    ...
    public Document getResponse(MRRequest request, XMPPI xmpp, MRLog log, MRDB db, MRResourceFactoryI resourceFactory, ServiceAgentFactoryI profileFactory)
        ...
        MediaStoreServiceUtils.sendRequestToMediaStoreAgent(request.getRequestName(), mediaStreamFileDoc, request, xmpp, log, db, resourceFactory, profileFactory);
