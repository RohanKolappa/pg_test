...
public class SuspendExportImportFileRequestHandler implements MRRequestHandlerI {
    ...
    public Document getResponse(MRRequest request, XMPPI xmpp, MRLog log, MRDB db, MRResourceFactoryI resourceFactory, ServiceAgentFactoryI serviceAgentFactory) throws Exception {
        ...
        //set Suspend /resume flag SystemWide
        FileSMQueue.getInstance().suspend(request, xmpp, log, db, resourceFactory, serviceAgentFactory, null);
