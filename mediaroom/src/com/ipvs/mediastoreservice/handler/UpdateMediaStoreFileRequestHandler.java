...
public class UpdateMediaStoreFileRequestHandler implements MRRequestHandlerI {
    ...
    public Document getResponse(MRRequest request, XMPPI xmpp, MRLog log, MRDB db, MRResourceFactoryI resourceFactory, ServiceAgentFactoryI profileFactory)
        ...
        mediaStoreServer.updateMediaFile(mediaStoreFileNID, mediaStreamFileNID, revision, mediaStreamFileDoc, rootDir);
