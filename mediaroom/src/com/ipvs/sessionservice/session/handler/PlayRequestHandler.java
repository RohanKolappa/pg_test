...
public class PlayRequestHandler extends SessionTrackActionRequestHandler implements MRRequestHandlerI {
	...
	public Document getResponse(MRRequest request, XMPPI xmpp, MRLog log,
		...
		return this.getTrackResponse(request, xmpp, log, db, resourceFactory, serviceAgentFactory, 
				MediaRoomServiceConst.TRACK_PLAY, MediaRoomServiceConst.TRACK_RESUME);
	}
