...
public class SkipBackRequestHandler extends SessionTrackActionRequestHandler implements MRRequestHandlerI{
	...
	public Document getResponse(MRRequest request, XMPPI xmpp, MRLog log,
		...
		return this.getTrackResponse(request, xmpp, log, db, resourceFactory, serviceAgentFactory, 
				SessionServiceConst.SKIPBACK, MediaRoomServiceConst.TRACK_SKIP_BACKWARD);
	}
