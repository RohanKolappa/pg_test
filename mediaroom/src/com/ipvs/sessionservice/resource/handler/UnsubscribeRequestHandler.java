...
public class UnsubscribeRequestHandler implements MRRequestHandlerI {
	...
	public Document getResponse(MRRequest request, XMPPI xmpp, MRLog log, MRDB db, MRResourceFactoryI resourceFactory, 
			...
			Element unsubscribeEl = MRXMLUtils.getElementXpath(doc, "//Unsubscribe");
			
			String whereNID = MRXMLUtils.getAttributeValue(unsubscribeEl, SessionServiceConst.WHERE_NID, "");
			String whereSubscriptionID = MRXMLUtils.getAttributeValue(unsubscribeEl, SessionServiceConst.WHERE_SUBSCRIPTION_ID, "");
			
			MRXMLDBUtils.unsubscribe(request, db, log, whereNID, whereSubscriptionID);
