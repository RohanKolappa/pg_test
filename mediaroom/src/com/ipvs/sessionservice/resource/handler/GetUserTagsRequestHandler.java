...
public class GetUserTagsRequestHandler extends GetTagsBaseRequestHandler{
	...
	public Document getResponse(MRRequest request, XMPPI xmpp, MRLog log,MRDB db, MRResourceFactoryI resourceFactory,
		...
		return getTags(SessionServiceConst.GET_USER_TAGS, SessionServiceConst.USER, request, xmpp, log, db, resourceFactory, serviceAgentFactory);		
	}
