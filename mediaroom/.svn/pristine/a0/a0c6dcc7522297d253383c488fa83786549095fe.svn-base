...
public final class SystemServiceConst {
    ...
    public static final String STARTDOWNLOADRESPONSEFILE = "/com/ipvs/systemservice/xml/StartDownloadingRequest.xml";
    ...
    public static final String RESTORE_DB_REQUEST_XML  = "/com/ipvs/systemservice/xml/RestoreDBRequest.xml";

    //HTTP Import const
    public static final String FILEXFERHTTPUPLOADREQUESTFILE = "/com/ipvs/systemservice/xml/FileXferHttpUploadRequest.xml";
    public static final String FILEXFERHTTPUPLOADRESPONSEFILE = "/com/ipvs/systemservice/xml/FileXferHttpUploadResponse.xml";
    ...
    public static final String NGSD200 = "ngs";
    ...
    public static final String SOFTWARE_URL = "http://"+_MS_IP_ADDRESS+"/mediaroom";
    public static final String DMS_SOFTWARE_URL = "upgrade_IMAGES";
    public static final String NGS_SOFTWARE_URL = "ngs_IMAGES";
    ...
    public static final String NGSD200_UPGRADE_DIR = "/home/onair/htdocs/public/mediaroom/ngs_IMAGES";
    public static final String NSGD200_DEVICE = "V2D-XPi-Device";
    public static final String UPGRADE_DEVICE_EL_NAME = "UpgradeDevice";
    public static final String UPGRADE_EL_NAME = "Upgrade";
    public static final String UPGRADE_FEATURE_SERVICE_VERSION = "2.27.1";
    public static final String DEPRECATED_FEATURE_SERVICE_VERSION = "2.31.1";
    public static final String UPGRADE_SUPPORTED_SOFTWARE_VERSION = "4.0.r9.b81145";
