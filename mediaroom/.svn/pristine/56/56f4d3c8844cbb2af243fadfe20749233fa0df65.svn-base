...
public class PauseRequestHandler extends SessionTrackActionRequestHandler implements MRRequestHandlerI {
	...
	public Document getResponse(MRRequest request, XMPPI xmpp, MRLog log,
		...
		return this.getTrackResponse(request, xmpp, log, db, resourceFactory, serviceAgentFactory, 
				MediaRoomServiceConst.TRACK_PAUSE, MediaRoomServiceConst.TRACK_PAUSE);
	}
