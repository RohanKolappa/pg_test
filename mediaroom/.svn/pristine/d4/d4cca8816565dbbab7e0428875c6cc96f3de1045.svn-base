...
public class GetPortTagsRequestHandler extends GetTagsBaseRequestHandler{
	...
	public Document getResponse(MRRequest request, XMPPI xmpp, MRLog log,MRDB db, MRResourceFactoryI resourceFactory,
		...
		return getTags(SessionServiceConst.GET_PORT_TAGS, SessionServiceConst.PORT, request, xmpp, log, db, resourceFactory, serviceAgentFactory);		
	}
