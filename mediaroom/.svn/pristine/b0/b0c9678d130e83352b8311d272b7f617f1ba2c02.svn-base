...
public class UpdateMediaMetaDataRequestHandler implements MRRequestHandlerI {
    ...
    public Document getResponse(MRRequest request, XMPPI xmpp, MRLog log, MRDB db, MRResourceFactoryI resourceFactory, ServiceAgentFactoryI profileFactory)
        ...
        mediaStoreServer.updateMediaMetaData(mediaStoreFileNID, mediaStreamFileNID, revision, actionDocument, rootDir);
