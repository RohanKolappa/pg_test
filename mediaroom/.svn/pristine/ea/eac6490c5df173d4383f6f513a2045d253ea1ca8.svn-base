...
public class UpdateMediaStreamFileResourceInfoRequestHandler implements MRRequestHandlerI {
    ...
    public Document getResponse(MRRequest request, XMPPI xmpp, MRLog log, MRDB db, MRResourceFactoryI resourceFactory, ServiceAgentFactoryI profileFactory)
		...
		Document responseDoc = new SetFileInfoRequestHandler().SetFileWithValidation(request, mediaStreamFileNID, "", "", groupsEL,"", xmpp, log, db, resourceFactory, profileFactory,true);
		return responseDoc;
    }
}
