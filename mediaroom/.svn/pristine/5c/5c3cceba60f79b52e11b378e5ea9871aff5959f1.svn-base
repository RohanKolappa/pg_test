...
public class GetFileTagsRequestHandler extends GetTagsBaseRequestHandler{
	...
	public Document getResponse(MRRequest request, XMPPI xmpp, MRLog log,MRDB db, MRResourceFactoryI resourceFactory,
		...
		return getTags(SessionServiceConst.GET_FILE_TAGS, SessionServiceConst.FILE, request, xmpp, log, db, resourceFactory, serviceAgentFactory);		
	}
