...
public class UpdateMediaStatusRequestHandler implements MRRequestHandlerI {
    ...
    public Document getResponse(MRRequest request, XMPPI xmpp, MRLog log, MRDB db, MRResourceFactoryI resourceFactory, ServiceAgentFactoryI profileFactory)
        ...
        mediaStoreServer.updateMediaStatus(mediaStoreFileNID, mediaStreamFileNID, revision, actionData, rootDir);
