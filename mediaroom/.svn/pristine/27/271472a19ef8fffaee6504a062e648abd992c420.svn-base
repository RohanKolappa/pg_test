...
public final class MediaRoomServiceConst {
    ...
    public static final String MEDIASTOREEVENTHANDLER = "com.barco.device.handler.MediaStore.MediaStoreEventHandler";
    ...
    public static final String ROOMOWNERJID = "roomOwnerJID";
    ...
    public static final String TEARDOWNREQUEST = "TeardownRequest";
    ...
    public static final String MEDIA_PRESENCE_EVENT = "MediaPresenceEvent";
    
    //SC reboot recovery
    //"Recovered_room"
    public static final String RECOVERED_ROOM = "Recovered_room";
    // Stream States
   ...
   /* //New event codes for book mark updates
    ...
    public static final String V2D_HARDWARE_DECODER_PORT  = "V2DHardWarePort";
    ...
    public static final String RTP_RAW = "RTP-RAW";
    public static final String RTP_PCM = "RTP-PCM";
    ...
    public static final int ASSET_INITIAL_CAPACITY = 67;
	...
	public static final String ROOM_OBSERVER_SERVICE_CONFIG = "SERVICECONFIG";
	public static int GC_SCHEDULE_INTERVAL = 90;
	
	public static final String FILE_INFO_ELEMENT = "FileInfo";
	public static final String GROUP_INFO_ELEMENT = "GroupInfo";
