...
public class GetServerTimeRequestHandler implements MRRequestHandlerI {
	...
	public Document getResponse(MRRequest request, XMPPI xmpp, MRLog log,
			...
			ServiceAgentFactoryI profileFactory) throws Exception {
	   return request.createResponseData("serverTime", 
			   String.valueOf(xmpp.getCurrentTimeMillis()));
	}
