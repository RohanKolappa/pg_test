...
public class FaultTolerantNegotiator extends StreamNegotiator {
    ...
    public FaultTolerantNegotiator(XMPPI connection, StreamNegotiator primary,
    ...
    final Packet initiateIncomingStream(XMPPI connection, StreamInitiation initiation) {
