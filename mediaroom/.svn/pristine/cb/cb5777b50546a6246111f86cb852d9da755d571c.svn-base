...
public abstract class StreamNegotiator {
    ...
    Packet initiateIncomingStream(XMPPI connection, StreamInitiation initiation) throws Exception {
        ...
        Packet streamMethodInitiation = collector
                .nextResult(OutgoingFileTransfer.getResponseTimeout());
        collector.cancel();
    ...
    abstract InputStream negotiateIncomingStream(Packet streamInitiation) throws Exception;
     ...
     *                       thrown.
     */
    public abstract InputStream createIncomingStream(StreamInitiation initiation) throws Exception;
