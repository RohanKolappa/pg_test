...
public class GetDirTagsRequestHandler extends GetTagsBaseRequestHandler{
	...
	public Document getResponse(MRRequest request, XMPPI xmpp, MRLog log,MRDB db, MRResourceFactoryI resourceFactory,
		...
		return getTags(SessionServiceConst.GET_DIR_TAGS, SessionServiceConst.DIR, request, xmpp, log, db, resourceFactory, serviceAgentFactory);		
	}
