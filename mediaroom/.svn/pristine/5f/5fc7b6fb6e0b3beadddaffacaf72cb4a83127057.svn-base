...
public class IBBTransferNegotiator extends StreamNegotiator {
     ...
     */
    protected IBBTransferNegotiator(XMPPI connection) {
    ...
    public OutputStream createOutgoingStream(String streamID, String initiator,
        ...
        IQ openResponse = (IQ) collector.nextResult(OutgoingFileTransfer.getResponseTimeout());
        collector.cancel();
        ...
        private boolean loadBufferWait() throws IOException {
            ...
            while (mess == null) {
                if (isDone) {
                    ...
                    mess = (Message) dataCollector.nextResult(OutgoingFileTransfer.getResponseTimeout());
                }
            }
            lastMess = mess;
