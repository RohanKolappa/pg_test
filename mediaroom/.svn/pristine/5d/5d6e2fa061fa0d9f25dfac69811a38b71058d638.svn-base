...
public class SaveConfigDeviceRequestHandler extends BaseDeviceRequestHandler{
	
	public Document getResponse(MRRequest request, XMPPI xmpp, MRLog log,
			MRDB db, MRResourceFactoryI resourceFactory,
			ServiceAgentFactoryI serviceAgentFactory) throws Exception {
		log.addInfo("SaveConfigDeviceRequestHandler::handleRequest", MRLog.OK, MRLog.NOTIFY);
		sendAgentRequest(request, xmpp, log, db, resourceFactory, serviceAgentFactory, "SaveConfigDeviceRequest");
