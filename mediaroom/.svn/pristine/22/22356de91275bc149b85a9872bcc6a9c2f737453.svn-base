...
public class Utils {	
    ...
    public static String randomString() {
    	String id = String.valueOf(randGen.nextInt(1000) + "-" + sequence++);
    	return id;
    }
    ...
    */
    ...
    public static String stringJoin(String preFix,String postFix,List<String> listOfValues,String joinString) {
    	if(listOfValues == null || listOfValues.isEmpty()) {
    		return "";
    	}
    	return preFix + StringUtils.join(listOfValues,joinString) + postFix;
    }
