...
#define NOT_FOUND_STR "Sorry, HTTP/1.0 404 Not found\r\n\r\n" \
    "<HEAD><TITLE>File Not Found</TITLE></HEAD>\n" \
    "<BODY><H1>File Not Found</H1></BODY>\n"

#define INVALID_REQUEST_STR "Sorry, HTTP/1.0 400 Invalid Request\r\n\r\n" \
    "<HEAD><TITLE>Invalid Request</TITLE></HEAD>\n" \
    "<BODY><H1>Invalid request</H1></BODY>\n"

/* #define OK_STR "Bingo ! HTTP/1.0 200 OK\nContent-Type: text/html\r\n\r\n" */
...
//	const static char* PROXY_OK_STR = "HTTP/1.0 200 OK\r\nContent-Type: octet-stream\r\nPragma: no-cache\r\n\r\n";
		const static char* PROXY_OK_STR = "Content-Type:octet-stream\nPragma: no-cache\n\n";
...
#endif //#ifdef LIBVNCSERVER_HAVE_HTTP