//============================================================================
// 633 WinTest Code.
// 633_packet,cpp: Ultra-simple 633 command-line communications example
...
//                              send_packet()
//
// send_packet() will send set the CRC in outgoing_command and send it to
// the host.
//----------------------------------------------------------------------------
void send_packet(void)
  ...
  //outgoing_command.CRC (like you would expect), but if data_length
   ...
   *packed_CRC_position;
  packed_CRC_position=
    (word *)&outgoing_command.data[outgoing_command.data_length];
  *packed_CRC_position=
    get_crc((ubyte *)&outgoing_command,outgoing_command.data_length+2,0xFFFF);
  //command, length, data[data_length], crc, crc
  SendData((ubyte *)&outgoing_command,outgoing_command.data_length+4);
  }
//============================================================================
//                              check_for_packet()
//
...
ubyte check_for_packet(void)
  ...
  if(incoming_response.CRC.as_word==
     get_crc((ubyte *)&incoming_response,incoming_response.data_length+2,0xFFFF))
    {
