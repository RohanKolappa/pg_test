...
public class MediaStoreFile2Dot4Impl implements MediaStoreFileI{
	...
	@Override
	public void updateMediaStoreFile(MediaStoreDirectoryInfo dirInfo,
			String mediaStoreFileID, Document mediaStoreFileDoc, String revision, Logger logger)
			throws Exception {
		// TODO Auto-generated method stub
	...
	@Override
	public long getMediaStoreFileSize(MediaStoreDirectoryInfo dirInfo,
			String mediaStoreFileID, Logger logger) throws Exception {
		// TODO Auto-generated method stub
		return 0;
	}
	...
	@Override
	public void createMediaStoreFile(MediaStoreDirectoryInfo dirInfo,
			String mediaStoreFileID, Document mediaStoreFileDoc, Logger logger) throws Exception {
		// TODO Auto-generated method stub
	}
	...
	@Override
	public void deleteFile(MediaStoreDirectoryInfo dirInfo, String fileUUID,
			String trashDirName, Logger logger)
			throws Exception {
		// TODO Auto-generated method stub
	...
	@Override
	public void updateMediaStoreBookmark(MediaStoreDirectoryInfo dirInfo, String mediaStoreFileID, String bookmarkID, Document mediaStoreBookmarkDoc, Logger logger)
			throws Exception {
		// TODO Auto-generated method stub
	...
	@Override
    public void upgradeFile(MediaStoreDirectoryInfo storeDirInfo, String fileUUID,
            Document mediaStoreBookmarkDoc, Logger logger) throws Exception {
        // TODO Auto-generated method stub
      
    }

    @Override
    public boolean isMediaStoreBookmarkExist(MediaStoreDirectoryInfo dirInfo, String mediaStoreFileID, String bookmarkID)
            throws Exception {
        // TODO Auto-generated method stub
        return false;
    }
