...
public class V2DRxMediaAgentImpl extends BaseMediaAgentImpl{
	
    public void initAgent(DeviceFrameworkI deviceFrameWork) {

	super.initAgent(deviceFrameWork);
	try {
	    super.startPlaying(deviceFrameWork, UUID.randomUUID().toString(), "1", MediaRoomServiceConst.SPLASHSCREEN_URL);
	} catch (Exception e) {
