...
/**
 * Associates a series of port-blocks with each instanceId.
 * 
 * Every reservation associates one additional port-block to the instanceId.
 * 
 * Releasing the instanceId releases all associated blocks. 
 */
