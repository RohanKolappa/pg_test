...
public class Utils {	
    ...
    */
    ...
    public static String generateSignature(String apiKey,String sharedSecret, String timestamp) throws Exception {
    ...
    public static int executeProcesswithNewLine( String[] cmd, StringBuffer buf) throws Exception { 
	Runtime rt = Runtime.getRuntime(); 
	Process process = rt.exec(cmd); 
	BufferedReader stdout = new BufferedReader(new InputStreamReader(process.getInputStream())); 
	String line = stdout.readLine(); 
