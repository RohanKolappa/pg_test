...
/**
 * The <code>Log4JErrorHandler</code> implements log4j's default error handling policy which consists of emitting a message for
 * the first error in an appender and ignoring all following errors.
 * 
 * <p>
