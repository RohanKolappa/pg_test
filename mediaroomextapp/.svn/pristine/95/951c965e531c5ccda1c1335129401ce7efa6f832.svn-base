...
public class DeviceTable {
	...
	public DeviceTable(String userJID, String deviceType, MRLog log, Document deviceDoc) {
	...
	private synchronized String addDeviceInstance(String deviceNID,
        ...
        Document instanceDoc = MRXMLUtils.getDocumentXpath(deviceDoc, "//InstanceList");
