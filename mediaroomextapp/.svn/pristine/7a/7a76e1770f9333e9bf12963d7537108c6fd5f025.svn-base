...
public class MediaTimeline1 {


    private static Element gMediaTimelineTemplate = null;
    Element mediaTimelineElement;

    MediaTimeline1(Element mediaTimelineElement) throws MRException,Exception{
    ...
    public static Element createTimelineUpdate(MediaTimeline1 mediaTimeline, Element streamNIDList,
    ...
    public static MediaTimeline1 createTimelineFromTrackDataDoc(Document trackDataDoc, MRLog log) throws Exception {
    	Element mediaTimelineElement = MRXMLUtils.getElementXpath(trackDataDoc, "//TrackMediaTimeline");
    	return new MediaTimeline1((Element)mediaTimelineElement.clone());
    }

    public static MediaTimeline1 createTimelineFromStreamDoc(Document streamDoc, MRLog log, String id) throws Exception {
    ...
    public Element handleTrackAction(MRRequest request, XMPPI xmpp, MRLog log,MRDB db, 
    		...
    		Element streamNIDList, String trimLength) throws MRException,Exception{
	    ...
	    lastTrackOffset = MediaTimeline1.isValidOffset(request, xmpp, log, db, trackAction, wallClock, startWallClock, lastTrackOffset, sourceType, playLength,sharedPVRStarTC, trimLength);
	    ...
	    long lastTC = 0;
	    MediaTimeline1.updateMediaTimelineElement(this.mediaTimelineElement, lastActionWallClock, lastTrackOffset, lastTC, newTimeScale, 
        ...
        Element timelineUpdate = MediaTimeline1.createTimelineUpdate(this, streamNIDList, roomNID, 
