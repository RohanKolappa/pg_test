...
public class MRRequest implements MRRequestI {
    ...
    */
    ...
    public static MRRequest createRequest(String userJID, Document doc, String appServerJID) throws Exception {
        int logLevel = Utils.getIntValue(MRXMLUtils.getValueXpath(doc, "//loglevel",""),0);
	...
	public Document marshalRequestObject(MRLog log, String responseHandlerName) throws MRException,Exception{
		...
		MRXMLUtils.setValueXpath(mrRequestDoc,"//superuser", String.valueOf(isSuperUser()));
    ...
    public static MRRequest unMarshalRequestObject(Document mrRequestDoc, Document requestDoc, String resourceGroup, MRLog log)
        ...
        String requestName = MRXMLUtils.getValueXpath(mrRequestDoc, "//requestname", "");
        String serviceName = MRXMLUtils.getValueXpath(mrRequestDoc, "//servicename", "");
        ...
        boolean superuser = Utils.getBoolean(MRXMLUtils.getValueXpath(mrRequestDoc, "//superuser", ""), false);
        int logLevel = Utils.getIntValue(MRXMLUtils.getValueXpath(mrRequestDoc, "//loglevel", ""), MRLog.INFO);
