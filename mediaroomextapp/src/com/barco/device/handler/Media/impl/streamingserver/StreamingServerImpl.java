...
import com.barco.utils.mr.ServiceAgentUtils;
...
public abstract class StreamingServerImpl implements StreamingServerI {
   ...
   /* public static void setInitialized(boolean isInitialized) {
	...
	public StreamingServerImpl(String userJID, MRLog log, XMPPI xmpp) {
   ...
   /* public void setNetworkResource(NetworkResource networkResource) {
    ...
    throws Exception {
        ...
        MRXMLUtils.addAttribute(inputEL,"startTime", String.valueOf(System.currentTimeMillis()));
    ...
    protected void sendProgressStoppedSSEventToSourceStreamAgent(Element outputElement,String ssInstanceNID) throws MRException,Exception {
		...
		// TBD Record SourceStreamAgent
		String sourceStreamAgent = "SourceStreamAgent";
	    String info = "StreamingServiceImpl :=" + userJID + " > DMSRecorderPort Progress Stopped SSEvent to " + sourceStreamAgent;
        ServiceAgentUtils.sendAgentEvent(xmpp, log, null, "", userJID, sourceStreamAgent, MRLog.OK, userJID, System.currentTimeMillis(), MediaRoomServiceConst.SSEVENT, ssEventDoc.getRootElement(), "", info);
    }
