...
static long keysym2ucs(unsigned short keysym)
{
    int min = 0;
...
bool CKeymap::KeySymToVirtualCode(UINT32 keySym, BYTE *vkCode)
{
...
bool CKeymap::VirtualCodeToKeySym(UINT32 *keySym, BYTE vkCode)
{
...
bool CKeymap::KeySymToUnicodeChar(UINT32 keySym, WCHAR *ch)
{
...
bool CKeymap::UnicodeCharToKeySym(WCHAR ch, UINT32 *keySym)
{
    if ((ch >= 32 && ch <= 126) || (ch >= 160 && ch <= 255)) {
        *keySym = ch;
        ...
        for (UINT i = 0; i < sizeof(keysymtab) / sizeof(struct codepair); i++) {
