...
##Graphics - WUXGA, 1920x1200##
#:Graphics-9.1 1920x1200 _@ 60 _MHz Out through DAC:
/V2O/bin/maint i2creg -a 0x20 -r 0x0C -W 0x42 # Power up part and Power down VDP
/V2O/bin/maint i2creg -a 0x20 -r 0x00 -W 0x19 # VID_STD=11001b for 1920x1200 _@ 60
...
/V2O/bin/maint i2creg -a 0x20 -r 0x03 -W 0x42 # 36 Bit SDR
...
/V2O/bin/maint i2creg -a 0x20 -r 0xb40 -W 0x5C # Adjust CP gain for PGA gain of 1.4
