...
extern int efdma_channel_acquire(struct _OMNITEK_INTERFACE_EXTENSION * pExt, int fdma_num,struct efdma_channel ** ppEFDMA_Channel, bool polling);
...
extern ssize_t efdma_channel_transmit_space(struct efdma_channel * pEFDMA_Channel);
...
extern int efdma_channel_set_tx_wake_func(struct efdma_channel * pEFDMA_Channel, efdma_tx_wake_func * tx_func, void * priv);

extern int efdma_channel_set_schedule_poll_callback(struct efdma_channel * pEFDMA_Channel, efdma_schedule_poll_func * poll_func, void * priv);

//Call for NAPI Poll function
int efdma_channel_receive_packets(struct efdma_ringbuffer * pEFDMA_RingBuffer, int nPackets);
//Call for NAPI to trigger updates to ringbuffer etc.
...
extern int efdma_channel_rx_restart(struct efdma_channel * pEFDMA_Channel);
extern int efdma_channel_tx_restart(struct efdma_channel * pEFDMA_Channel);

extern bool efdma_channel_rx_running(struct efdma_channel * pEFDMA_Channel);
extern bool efdma_channel_tx_running(struct efdma_channel * pEFDMA_Channel);


//Start EFDMA channel...
extern int efdma_channel_start(struct efdma_channel * pEFDMA_Channel);

//Enable/disable RX interrupts from this EFDMA channel...
extern void efdma_channel_rx_interrupt_enable(struct efdma_channel * pEFDMA_Channel, bool enable);
...
/*!
 ...
 \section EFDMA_OVERVIEW Overview
 ...
 \subsection EFDMA_RING_BUFFERS Ring Buffers
 ...
 \subsection EFDMA_PACKET_LAYER Packet Layer
 ...
 \subsubsection EFDMA_PACKET_TRANSMISSION Packet Transmission
 ...
 \subsubsection EFDMA_PACKET_RECEPTION Packet Reception
 ...
 \section EFDMA_MODULE_USE Using the EFDMA Module
 ...
 Packet reception is indicated by a call to the packet receive function.  This should then call efdma_channel_receive_packet() to copy data from the buffer.
 ...
 \section EFDMA_THROTTLE_BEHAVIOUR Throttle Behaviour
