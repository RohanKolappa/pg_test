...
#define DEFAULT_P2P_COEFF_P  ((int32_t)0xFFF00000)
#define DEFAULT_P2P_COEFF_I  ((int32_t)0x80000000)
#define DEFAULT_P2P_COEFF_D  ((int32_t)0x80000000)

#define DEFAULT_E2E_COEFF_P  ((int32_t)0xF8000000)
#define DEFAULT_E2E_COEFF_I  ((int32_t)0xFC000000)
#define DEFAULT_E2E_COEFF_D  ((int32_t)0x00000000)
...
typedef struct {
  /* Enable RTC changes */
  uint32_t rtcChangesAllowed;  /* ptp->rtcChangesAllowed */
  /* Enable AVB delay timestamps */
  uint32_t delayTimestampEnable;  /* ptp->delayTimestampEnable */
} PtpServiceFlags;
#define IOC_PTP_SET_SERVICE_FLAGS _IOWR('p', 0x2f, PtpServiceFlags)
