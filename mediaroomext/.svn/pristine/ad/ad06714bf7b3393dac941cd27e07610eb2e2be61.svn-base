package com.ipvs.ext.example; // *** change this to your package name
...
public class CmdLineClient extends IpvsXmppXMLClient implements IpvsXmppLoggerI {
	...
	public static void main(String[] args) throws Exception {
		...
		// <iq><query><ServiceLogin clientVersion='2.30.4'><clientPrivateKey>Barco$123</clientPrivateKey></ServiceLogin></query></iq>
		// <iq><query><GetSession/></query></iq>
		// <iq><query><PerfTest whereContactJID='xpi@localhost/xpi'/></query></iq>
