<xsl:stylesheet version="1.0"
	...
	<xsl:template
			match="//MediaStreamSrcPortResource[Info/StreamTypeList/StreamType='V2D']/InstanceInfo/InstanceList/Instance[@mode!='AutoStart']/MediaStreamInfo/MediaStreamProfileInfo">
			<xsl:choose>
		...
		<xsl:template match="//Instance[@mode!='AutoStart']" mode='add-atts'>
			<xsl:if test="//MediaStreamSrcPortResource[Info/StreamTypeList/StreamType='V2D']">
