<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
    ...
    <xsl:template mode="add-atts" match="/MediaStreamSrcPortResource">
    ...
    <!-- DELETE ELEMENTS MediaStreamSrcPortResource ( were present in 'objectXml_1.0' but removed from 'objectXml_1.3') -->

    <xsl:template match="/MediaStreamSrcPortResource/InstanceInfo/InstanceList/ResourceInstance/StreamNID"/>
    <xsl:template match="/MediaStreamSrcPortResource/Contact/Reachable"/>
    <xsl:template match="/MediaStreamSrcPortResource/InstanceInfo/InstanceList/ResourceInstance/RoomNID"/>
    <xsl:template match="/MediaStreamSrcPortResource/Info/MediaTypeList"/>


    <!-- Add ELEMENTS MediaStreamSrcPortResource ( were absent in 'objectXml_1.0' but added to  'objectXml_1.3') -->

    <!--
        /MediaStreamSrcPortResource/ProfileInfo /MediaStreamSrcPortResource/Contact/Presence /MediaStreamSrcPortResource/InstanceInfo/InstanceList/ResourceInstance/MediaStreamInfo
        /MediaStreamSrcPortResource/Info/StreamTypeList/StreamURLType
    -->

    <xsl:template mode="append" match="/MediaStreamSrcPortResource">
    ...
    <xsl:template mode="append" match="/MediaStreamSrcPortResource/Contact">
    ...
    <xsl:template mode="append" match="/MediaStreamSrcPortResource/State">
    ...
    <xsl:template mode="append" match="/MediaStreamSrcPortResource/InstanceInfo/InstanceList/ResourceInstance">
    ...
    <xsl:template mode="append" match="/MediaStreamSrcPortResource/Info/StreamTypeList">
