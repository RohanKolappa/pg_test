<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
   ...
   <xsl:template match="/IPVSClient-Device//IPVSClientDisplayConfig/Canvas/Window/Geometry/@transparency">
    ...
    <xsl:template match="//DeviceStatus">
        ...
        <xsl:choose>
            <xsl:when test='"2.25.5"=$objectXml_serviceVer'>
