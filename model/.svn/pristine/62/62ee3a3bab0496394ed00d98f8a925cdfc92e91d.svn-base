<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
    ...
    <xsl:template mode="after" match="//IPVSClient-Device/DeviceConfig/*/*/AgentList/XMPPAgentServiceXAuthAgentConfig">
		<XMPPAgentServicePortCtrlAgentConfig Dirty="CLEAN">
				<Enable>true</Enable>
				<TargetPortTableConfig Configurable="false" Dirty="CLEAN"/>
		</XMPPAgentServicePortCtrlAgentConfig>
    </xsl:template>
    ...
    <xsl:template match="//DeviceStatus">
        ...
        <xsl:choose>
            <xsl:when test='"2.10"=$objectXml_serviceVer'>
