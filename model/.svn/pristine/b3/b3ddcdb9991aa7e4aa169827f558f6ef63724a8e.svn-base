<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
	...
	<xsl:template match="//PolicyAdminRoleSet" mode='insert'>
		<PolicyAdminObjectRole>
			...
			<RoleAction>Upgrade</RoleAction>
		</PolicyAdminObjectRole>
		<PolicyAdminObjectRole>
			<RoleObject>System</RoleObject>
			<RoleAction>Restore</RoleAction>
		</PolicyAdminObjectRole>
		<PolicyAdminObjectRole>
			<RoleObject>System</RoleObject>
			<RoleAction>Backup</RoleAction>
		</PolicyAdminObjectRole>
		<PolicyAdminObjectRole>
			<RoleObject>System</RoleObject>
			<RoleAction>Report</RoleAction>
		</PolicyAdminObjectRole>
		<PolicyAdminObjectRole>
			<RoleObject>System</RoleObject>
			<RoleAction>SessionManagement</RoleAction>
		</PolicyAdminObjectRole>
	</xsl:template>
</xsl:stylesheet>
