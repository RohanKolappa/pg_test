<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
    ...
    <xsl:template match="//DeviceStatus[not(*)]">
        ...
        <xsl:choose>
            <xsl:when test='"2.32.3"=$objectXml_serviceVer'>
    ...
    <xsl:template match="//HAServiceConfig/HAServer" mode="append">
		<xsl:if	test="//MS-Device or //MS-25-Device">
			<VirtualIP2>0.0.0.0</VirtualIP2>
		</xsl:if>
	</xsl:template>
