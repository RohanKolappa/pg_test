<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
    ...
    <xsl:template match="//DeviceStatus">
        ...
        <xsl:choose>
            <xsl:when test='"2.19"=$objectXml_serviceVer'>
    ...
    <xsl:template match="//IPVSDBService" name="applyCluster" mode="append">
       <Cluster>
             <ClusterPort></ClusterPort>
       </Cluster>    
    </xsl:template>
    
     <xsl:template match="/*[name()='MS-Device']//XMPPServiceConfig" name="applyHAServiceConfig" mode="append">
        <HAServer>
