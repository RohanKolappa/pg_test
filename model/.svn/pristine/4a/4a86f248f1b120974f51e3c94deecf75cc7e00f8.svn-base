<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
    ...
    <xsl:template match="//DeviceStatus[not(*)]">
        ...
        <xsl:choose>
            <xsl:when test='"2.30.7"=$objectXml_serviceVer'>
    ...
    <xsl:template match="//XMPPServiceConfig/XMPPServer" mode="append">
		<xsl:if test="//MS-Device or //MS-25-Device or //DMS-25-Device or 
