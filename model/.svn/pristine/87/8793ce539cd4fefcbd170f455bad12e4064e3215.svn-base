<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
    ...
    <xsl:template match="//DeviceStatus[not(*)]">
        ...
        <xsl:choose>
            <xsl:when test='"2.31.8"=$objectXml_serviceVer'>
	...
	<!--  Remove SyncPolarity from  ORB, V2D TX and XP devices -->
    <xsl:template match="//ORBEncoderPortConfig/V2DCodecVideoLookupTable/V2DCodecVideoLookupEntryConfig/SyncPolarity"/>
    <xsl:template match="//V2DEncoderConfig/V2DCodecVideoLookupTable/V2DCodecVideoLookupEntryConfig/SyncPolarity"/>
    <xsl:template match="//XP200PortConfig/V2DCodecVideoLookupTable/V2DCodecVideoLookupEntryConfig/SyncPolarity"/>
