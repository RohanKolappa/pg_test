<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
    ...
    <xsl:template match="//DeviceStatus[not(*)]">
        ...
        <xsl:choose>
            <xsl:when test='"2.28.10"=$objectXml_serviceVer'>
    ...
    <xsl:template match="//ServiceElementsConfig/XMPPAgentServiceConfig/User">      
         <DeviceName><xsl:value-of select="."/></DeviceName> 
    </xsl:template>
    <xsl:template match="//ServiceElementsConfig/XMPPAgentServiceConfig/Password">      
         <DevicePassword><xsl:value-of select="."/></DevicePassword> 
    </xsl:template>
    <xsl:template match="//ServiceElementsConfig/XMPPAgentServiceConfig/AgentID"/> 
</xsl:stylesheet>
