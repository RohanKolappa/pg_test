<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
    ...
    <xsl:template match="//HardDiskTableConfig">
        <HardDiskTableConfig Dirty="CLEAN">
            <HardDiskEntry Dirty="CLEAN" ListIndex="1">
                ...
                <RAIDArrayEntry>
                    ...
                    <Unit>u0</Unit>
                    <xsl:choose>
                        <xsl:when test='"DMS-100-Device"=$devname'>
                        ...
                        <xsl:when test='"DMS-1200-Device"=$devname'>
                ...
                <MediaStore>
                    <Name>/data1</Name>
                    <RootDirPath>/data/DSS/data/portal/site</RootDirPath>
                </MediaStore>
            </HardDiskEntry>
            <xsl:choose>
                <xsl:when test='"DMS-1500-Device"=$devname'>
                    <HardDiskEntry Dirty="CLEAN" ListIndex="2">
                        ...
                        <MediaStore>
                            <Name>/data2</Name>
                            <RootDirPath>/data2/DSS/data/portal/site</RootDirPath>
                        </MediaStore>
                    </HardDiskEntry>
                </xsl:when>
            </xsl:choose>
    ...
    <xsl:template match="//DeviceStatus">
        ...
        <xsl:choose>
            <xsl:when test='"1.5"=$objectXml_serviceVer'>
