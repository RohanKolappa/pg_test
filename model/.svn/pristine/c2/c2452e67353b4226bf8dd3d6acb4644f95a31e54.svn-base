	...
	<xsl:template match="/">
		<MediaStoreAdminPolicyRule NID="" Rev="1" Ver="1.3" parentNID="default.mediastoreadminpolicyrulelist" serviceVer="2.29.16">
			<xsl:variable name="mediaroompolicynid">
			 ...
			 <xsl:attribute name="NID">default.mediastoreadminpolicyrulelist.msaprl_<xsl:value-of select="substring-after($mediaroompolicynid,'mrprl_')"/>_2_28_20</xsl:attribute>
			<rulename>
