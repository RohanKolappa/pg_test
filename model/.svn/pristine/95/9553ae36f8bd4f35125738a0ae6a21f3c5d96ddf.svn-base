...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
	...
	<xsl:template match="/">
		<MediaStoreAdminPolicyRule NID="" Rev="1" Ver="1.3" parentNID="default.mediastoreadminpolicyrulelist" serviceVer="2.28.2">
			<xsl:variable name="mediaroompolicynid">
				<xsl:value-of select="/MediaRoomPolicyRule/@NID" />
			</xsl:variable>
			 <xsl:attribute name="NID">default.mediastoreadminpolicyrulelist.msaprl_<xsl:value-of select="substring-after($mediaroompolicynid,'mrprl_')"/>_2</xsl:attribute>
			<rulename>
